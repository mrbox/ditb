...
def slugify(value, do_slugify=True, overwrite_char_map={}):
    """
    Function to making slug from strings. Source: http://trac.django-fr.org/browser/site/trunk/djangofr/links/slughifi.py
    """
    ...
    def slughifi(value, do_slugify=True, overwrite_char_map={}):
        ...
        if do_slugify:
            value = dj_slugify(value)

        return value.encode('ascii', 'ignore')

    return slughifi(value, do_slugify, overwrite_char_map)
